...
public interface CobrancaRepository extends JpaRepository<UploadFile, Long> {
    ...
    @Query(value = "select id as codigo, nome_arquivo as nomeArquivo "+
            ...
            "and to_char(data_hora_inclusao, 'yyyy-mm') = ?2",
            nativeQuery = true)
    Optional<List<CodigosDasCobrancas>> findAllCodigosByData(long idEmpresa, String data);
